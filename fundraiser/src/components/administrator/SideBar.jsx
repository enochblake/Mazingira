...
<MenuItem
    ...
    {!isCollapsed &&(
        <Box>
         <Box class="mt-5">
    <img id="admin" className="mx-auto" src=""alt ="" width="100px" height="100px"/>
</Box>   
 <Box class="mt-4">
   <h1 className="text-2xl text-center text-white font-bold">Mazingira</h1>
   <h5 className="text-center text-green-600">ADMIN</h5>
</Box>  
 </Box>
